...
if __name__ == '__main__':
    ...
    cfg = {
        ...
        'save_lhand_verts': False, # if True, will compute and save the left hand vertices
        'save_rhand_verts': True, # if True, will compute and save the right hand vertices
